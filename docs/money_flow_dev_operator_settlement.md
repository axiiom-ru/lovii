...
flowchart TD
    ...
    T -->|"Лицензиар · пул<br/>65 ₽ (10% − экв.)"| C["Компания-разработчик<br/>(Лицензиар)"]
    C -->|"расчётный счёт · 40%<br/>26 ₽ + акт"| R["Представитель"]
    C -->|"расчётный счёт · 20%<br/>13 ₽ + акт"| A["Амбассадор"]
    S -->|"кассовый чек 54-ФЗ → Покупателю"| D["Закрывающие документы"]
    C -->|"акт → Представителю"| D
    C -->|"акт → Амбассадору"| D
    ...
    class P buyer; class B bank; class T transit; class S shop; class C dev; class R rep; class A rep; class D doc;
```
...
flowchart TD
    ...
    T -->|"Точка (Лицензиат) · 90%<br/>900 ₽"| S["Торговая точка<br/>выручка 900 ₽"]
    T -->|"Лицензиар · пул<br/>74,10 ₽ (10% − экв.)"| C["Компания-разработчик<br/>(Лицензиар)"]
    C -->|"расчётный счёт · 40%<br/>29,64 ₽ + акт"| R["Представитель"]
    C -->|"расчётный счёт · 20%<br/>14,82 ₽ + акт"| A["Амбассадор"]
    S -->|"кассовый чек 54-ФЗ → Покупателю"| D["Закрывающие документы"]
    C -->|"акт → Представителю"| D
    C -->|"акт → Амбассадору"| D
...
flowchart TD
    ...
    T -->|"Точка (Лицензиат) · 90%<br/>900 ₽"| S["Торговая точка<br/>выручка 900 ₽"]
    T -->|"Лицензиар · пул<br/>93,00 ₽ (10% − экв.)"| C["Компания-разработчик<br/>(Лицензиар)"]
    C -->|"расчётный счёт · 40%<br/>37,20 ₽ + акт"| R["Представитель"]
    C -->|"расчётный счёт · 20%<br/>18,60 ₽ + акт"| A["Амбассадор"]
    S -->|"кассовый чек 54-ФЗ → Покупателю"| D["Закрывающие документы"]
    C -->|"акт → Представителю"| D
    C -->|"акт → Амбассадору"| D
...
- **Закрывающие документы**: кассовый чек 54-ФЗ выбивает **Точка → Покупателю**; акты/справки
  по выплатам **Лицензиар → Представителю** и **Лицензиар → Амбассадору** (на схеме — стрелки
  к узлу «Закрывающие документы»).
...
На github.com этот <script> вырезается санитайзером (там Mermaid рисуют нативно). -->
