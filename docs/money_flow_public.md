...
> **Тест:** проверка автоматической публикации — контрольная правка (будет удалена).
...
| Остаток на номинальном счёте | 974,10 ₽ | 993,00 ₽ |
| Торговая точка (Лицензиат/Принципал) — Выручка, 90% | 900,00 ₽ | 900,00 ₽ |
| **Пул Лицензионного вознаграждения (Правообладатель)** | **74,10 ₽** | **93,00 ₽** |
| → Правообладатель удерживает (40%) | 29,64 ₽ | 37,20 ₽ |
